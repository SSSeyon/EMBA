...
const SCHOOLS = [
  {
    ...
    start: 'Sep 2026',
    deadline: '2026-08-15',
    deadlineNote: 'Sep 2026 start — date UNCONFIRMED, verify with Judge',
    estimated: true,
    flag: 'This deadline is an estimate, not a confirmed date. The Sep 2026 intake may already be closed. Contact Cambridge Judge admissions before relying on this countdown.',
...
const ACTIONS = [
  t('a1', 'Apply to Cambridge Judge EMBA (Sep 2026 start)', '2026-08-15'),
